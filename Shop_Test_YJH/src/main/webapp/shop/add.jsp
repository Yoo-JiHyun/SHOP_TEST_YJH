	...
	<div class="container shop m-auto mb-5">
		<form name="product" action="./add_pro.jsp" onsubmit="return checkProduct()" method="post" enctype="multipart/form-data">
			...
			<div class="input-group mb-3 row">
				...
				<input type="text" name="productId" class="form-control col-md-10">
			</div>
			...
			<div class="input-group mb-3 row">
				...
				<input type="text" name="unitPrice" class="form-control col-md-10">
			</div>
			
			<div class="input-group mb-3 row">
				<label class="input-group-text">상세 정보</label>
				<textarea name="description" cols="50" rows="10"></textarea>
			</div>
			
			<div class="input-group mb-3 row">
				<label class="input-group-text col-md-2">제조사</label>
				<input type="text" name="manufacturer" class="form-control col-md-10">
			</div>
			
			<div class="input-group mb-3 row">
				<label class="input-group-text col-md-2">분류</label>
				<input type="text" name="category" class="form-control col-md-10">
			</div>
			
			<div class="input-group mb-3 row">
				<label class="input-group-text col-md-2">재고 수</label>
				<input type="text" name="unitsInStock" class="form-control col-md-10">
			</div>
